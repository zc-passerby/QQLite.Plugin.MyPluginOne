...
namespace PasserbyPluginNS
{
    ...
    {
        //数据库连接字符串
        public static string connectionString = "default.db";
        ...
        public static int ExecuteSql(string SQLString)
        {
            using (SQLiteConnection connection = new SQLiteConnection(connectionString))
            {
                using (SQLiteCommand cmd = new SQLiteCommand(SQLString, connection))
                {
                    ...
                    {
                        connection.Close();
                        PrintErrorMessage("ExecuteSql", E);
        ...
        public static void ExecuteSqlTran(ArrayList SQLStringList)
        {
            using (SQLiteConnection conn = new SQLiteConnection(connectionString))
            {
                ...
                {
                    tx.Rollback();
                    PrintErrorMessage("ExecuteSqlTran", E);
                    throw new Exception(E.Message);
                }
            }
        }
        ...
        public static int ExecuteSqlInsertImg(string strSQL, byte[] fs)
        {
            using (SQLiteConnection connection = new SQLiteConnection(connectionString))
            {
                ...
                {
                    PrintErrorMessage("ExecuteSqlInsertImg", E);
                    throw new Exception(E.Message);
                }
                finally
                {
        ...
        public static SQLiteDataReader ExecuteReader(string strSQL)
        {
            ...
            {
                PrintErrorMessage("ExecuteReader", e);
                throw new Exception(e.Message);
            }
